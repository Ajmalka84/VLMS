...
export const MachineryManagement: React.FC = () => {
  ...
  return (
    <div className="space-y-4">
      {/* Top Action Bar */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-surface p-4 rounded-2xl border border-subtle">
        <div>
      ...
      {/* Content */}
      {isLoading ? (
        <div className="p-12 text-center text-xs text-muted font-semibold animate-pulse">
        ...
        <div className="rounded-2xl border border-subtle bg-surface overflow-hidden shadow-xl">
          <table className="w-full text-left text-xs text-secondary">
            <thead className="bg-surface-solid text-[10px] uppercase font-bold text-secondary border-b border-subtle">
              <tr>
              ...
              {machineryList.map((m) => (
                <tr key={m.id} className="hover:bg-surface-hover transition">
                  ...
                  <td className="px-4 py-3 font-mono font-bold text-secondary">
                    {m.code ? (
                      <span className="px-2 py-0.5 rounded-lg bg-surface-solid border border-subtle text-amber-300">
                        {m.code}
                      </span>
                    ) : (
                  ...
                  <td className="px-4 py-3">
                    {m.vendorName || m.vendorMobile ? (
                      <div className="space-y-0.5">
                        ...
                        {m.vendorMobile && (
                          <div className="text-muted text-[10px] flex items-center gap-1 font-mono">
                      ...
                      <span className="text-muted">In-house / Direct</span>
                    )}
                  </td>
                  <td className="px-4 py-3">
                    <button
